...
from onmt.modules.multi_headed_attn import MultiHeadedAttention, SelfMultiHeadedAttention
...
__all__ = ["Elementwise", "context_gate_factory", "ContextGate",
           ...
           "MultiHeadedAttention", "SelfMultiHeadedAttention", "Embeddings", "PositionalEncoding",
